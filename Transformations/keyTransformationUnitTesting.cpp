...
bool keyTransformationTest5() {
    unsigned char initialKey[2][8][4] = { {
            {0x00, 0x04, 0x08, 0x0c},
            {0x01, 0x05, 0x09, 0x0d},
            {0x02, 0x06, 0x0a, 0x0e},
            {0x03, 0x07, 0x0b, 0x0f}
...
int main() {
    ...
    if (keyTransformationTest1()) tests++;
    if (keyTransformationTest2()) tests++;
    if (keyTransformationTest3()) tests++;
    if (keyTransformationTest4()) tests++;
    if (keyTransformationTest5()) tests++;
    if (keyTransformationTest6()) tests++;
    if (keyTransformationTest7()) tests++;
    if (keyTransformationTest8()) tests++;
    if (keyTransformationTest9()) tests++;
    if (keyTransformationTest10()) tests++;
    if (keyTransformationTest11()) tests++;
    if (keyTransformationTest12()) tests++;
    if (keyTransformationTest13()) tests++;
    if (keyTransformationTest14()) tests++;
    if (keyTransformationTest15()) tests++;

    cout << "Key transformation tests " << tests << "/15: " << ((tests == 15) ? "Success" : "Failed") << endl;
